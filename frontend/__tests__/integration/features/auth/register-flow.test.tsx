...
describe('RegisterTemplate', () => {
  ...
  describe('ゲスト登録フォーム', () => {
    it('ゲスト用のタイトルと説明が表示される', async () => {
      ...
      await expect.element(page.getByText('ゲストプロフィール登録')).toBeVisible()
      await expect
        .element(page.getByText('ゲストとしてプロフィール情報を入力してください'))
        .toBeVisible()
    })
    ...
    it('必須フィールドが表示される', async () => {
      ...
      await expect.element(page.getByRole('button', { name: '登録する' })).toBeVisible()
    })
  ...
  describe('キャスト登録フォーム', () => {
    it('キャスト用のタイトルと説明が表示される', async () => {
      ...
      await expect.element(page.getByText('キャストプロフィール登録')).toBeVisible()
      await expect
        .element(page.getByText('キャストとしてプロフィール情報を入力してください'))
        .toBeVisible()
    })
